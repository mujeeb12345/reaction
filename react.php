<?php
// Script Created By Bilal Ashraf// to use this script just attach it with the simple bot script and use the iphone on that script it will get tokens from XD
...
{
	$access_token= file_get_contents('XD/'.$file_array[$i]);
